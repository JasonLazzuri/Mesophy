...
-- Drop helper functions with CASCADE to handle dependencies
DROP FUNCTION IF EXISTS get_user_organization_id() CASCADE;
DROP FUNCTION IF EXISTS get_user_role() CASCADE;
DROP FUNCTION IF EXISTS can_access_district(UUID) CASCADE;
DROP FUNCTION IF EXISTS can_access_location(UUID) CASCADE;
