...
-- Drop ALL possible policy names (including ones from previous versions)
DO $$ 
DECLARE
    r RECORD;
BEGIN
...
RAISE NOTICE '✅ User profiles base policy created';
...
RAISE NOTICE '✅ Districts policies created';
...
RAISE NOTICE '✅ Locations policies created';
...
RAISE NOTICE '✅ Screens policies created';
...
RAISE NOTICE '✅ All content policies created';
...
RAISE NOTICE '✅ Helper functions recreated';
